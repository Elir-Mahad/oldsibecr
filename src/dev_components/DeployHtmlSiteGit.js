	...
	return (
		<div className="blog">
			<div className="titletag">
				<h1 className="title">Deploy basic html/css sites via github pages</h1>
			...
			<div className="content">
				<div className="blogbody">
					...
					<p>
						...
						particular process. For this example, we are going to deploy a
						website ‘hogwartz'.
					</p>
					...
					<div className="paragraph">
						...
						<ul>
							<li>
								On your desktop, open the folder 'hogwartz' inside visual studio
								code
							</li>
							<li>
							...
							<li>
								If your'e not operating from within the 'hogwartz' folder, then
								inside the vsc terminal type
							</li>
							<li className="code">cd hogwartz</li>
						</ul>
					</div>
					<div className="paragraph">
						...
						<ul>
							...
							<li className="code">
								git remote add origin https://github.com/Elir-Mahad/hogwartz.git
							</li>
							<li>
							...
							<li>
								Go to your github repository and verify whether files have been
								uploaded or not
							</li>
							<li>
								You should see two files , index.html and style.css , in your
								repository
							</li>
						</ul>
					</div>
					<div className="paragraph">
						...
						<ul>
							<li>
								Go back to your Github repository 'hogwartz'; click on settings
							</li>
							<li>Scroll down on settings untill you see github pages</li>
							<li>Change the branch to master, save, and refresh the page</li>
							<li>You will now see the below line</li>
							<li className="code">
								Your site is published at https://elir-mahad.github.io/hogwartz/
							</li>
							<li>
