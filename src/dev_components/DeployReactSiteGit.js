			...
			<div className="content">
				<div className="blogbody">
					...
					<p>
						...
						process that's used to deploy regular sites on github pages. I
						repeteadly found myself on stackoverflow trying to remember the
						process for deploying react sites on github.
					</p>
					<h2 className="focus">Solution</h2>
					<p>
						To avoid wasting time, i wrote down a step by step manual for this
						particular process. For this example, we are going to deploy a react
						app called ‘solitaire.
					</p>
					...
					<div className="paragraph">
						...
						<ul>
							...
							<li>
								Once you see the 'quick set up' page, leave that page open in
								your browser, and move on to the 2nd step.
							</li>
						</ul>
					</div>
					<div className="paragraph">
						...
						<ul>
							<li>
								Instal 'yarn' via the administrator account of your computer:
							</li>
							<li className="code">npm i -g yarn</li>
							<li>Create react app :</li>
							<li className="code">npx create-react-app solitaire</li>
							<li>When this folder is downloaded, put it on your desktop.</li>
							<li>
								cd into the solitaire folder, and connect your local solitaire
								folder, to the solitaire repository in your Github pages:
							</li>
					...
					<div className="paragraph">
						...
						<ul>
							<li>
								...
								currently on your desktop, to your Github repository solitaire,
								which is on the Github website.
							</li>
							<li>
								On the quick set up page, copy and paste the two lines that are
					...
					<div className="paragraph">
						...
						<ul>
							<li>
								Paste the two lines that you've have copied, into the terminal
							</li>
							<li>
								Below is the first line. It will give you remote control of your
								Github repository.
							</li>
							<li className="code">
							...
							<li>
								Below is the second line. It will upload the folder into your
								repository. You will be asked to provide your Github username
								and password, so be ready to insert them into the terminal.
							</li>
					...
					<div className="paragraph">
						...
						<ul>
							...
							<li>Refresh the page, and you will see your react apps url.</li>
					...
					<div className="paragraph">
						...
						<ul>
							...
							<li>
								On the left panel, under 'gitignore' you will see a file titled
								‘package.json’
							</li>
					...
					<div className="paragraph">
						...
						<ul>
							...
							<li className="code">git add .</li>
							<li className="code">git commit -m “Add Github Pages config.”</li>
							<li className="code">yarn run deploy</li>
							<li>
								Go to GitHub settings and change branch from master to gh-pages
								branch
							</li>
							<li>
					...
					<div className="paragraph">
						...
						<ul>
							...
							<li>
								...
								files/changes, and it will update the site with the new changes.
							</li>
						</ul>
					</div>
				</div>
